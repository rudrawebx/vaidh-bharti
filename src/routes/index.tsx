...
import { ArrowRight, Leaf, HeartHandshake, Sparkles, Star, Users, X, ZoomIn } from "lucide-react";
...
function Gallery() {
  ...
  const shots = [
    { src: "/assets/real/clinic-cottage.jpeg", alt: "Traditional bamboo cottage therapy suites at Panchsheel Aarogya Dhaam" },
    { src: "/assets/real/clinic-lawn.jpeg", alt: "Lush botanical gardens and green healing lawns" },
    { src: "/assets/real/dispensary-patients.jpeg", alt: "Ayurvedic consultation and dispensary at Panchsheel Aarogya Dhaam" },
    { src: "/assets/real/vaidh-meditation.png", alt: "Vaidh Jitender Bharti in morning meditation at the ashram" },
    { src: "/assets/real/herbal-spices.jpg", alt: "Authentic whole Ayurvedic herbs, roots and raw spices" },
    { src: "/assets/real/cinnamon-mortar.jpg", alt: "Traditional stone pestle and mortar processing classical churnas" },
    { src: "/assets/real/stage-assembly.jpeg", alt: "Community health assembly and Ayurvedic discourse" },
    { src: "/assets/real/herbal-tea-ceremony.jpg", alt: "Traditional preparation of restorative Ayurvedic herbal teas and kwath" },
  ];
  ...
  return (
    <section className="py-24 sm:py-32">
      <Container>
        <div className="flex flex-wrap items-end justify-between gap-6">
          <SectionHeading eyebrow="Visual Story" title="Inside Panchsheel Aarogya Dhaam" subtitle="A glimpse into the peaceful grounds, therapies, and authentic Ayurvedic preparations." />
          <Link
            to="/gallery"
            className="group inline-flex items-center gap-2 text-[12px] font-semibold uppercase tracking-[0.14em] text-primary"
          >
        ...
        {/* Uncropped Responsive Masonry Gallery without names */}
        <div className="mt-12 columns-2 sm:columns-3 lg:columns-4 gap-4 space-y-4">
          {shots.map((s, i) => (
            <div key={`${s.src}-${i}`} className="break-inside-avoid">
              <button
                type="button"
                onClick={() => setActive(s)}
              ...
              >
                <div className="relative overflow-hidden bg-[#FAF7F2] flex items-center justify-center">
                  ...
                  <div className="absolute inset-0 bg-black/0 transition-colors duration-300 group-hover:bg-black/25 flex items-center justify-center">
                    <span className="opacity-0 transition-all duration-300 group-hover:opacity-100 group-hover:scale-110 rounded-full bg-background/90 p-2.5 text-foreground shadow-xl">
        ...
        <div className="mt-12 flex justify-center">
          <Link
            to="/gallery"
            className="group inline-flex items-center gap-2 rounded-sm border border-primary/20 bg-card px-7 py-3.5 text-[12px] font-semibold uppercase tracking-[0.14em] text-primary shadow-sm transition-all hover:border-gold hover:bg-primary hover:text-primary-foreground"
          >
            Explore All 15 Photos
            <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
          </Link>
        </div>
      </Container>
